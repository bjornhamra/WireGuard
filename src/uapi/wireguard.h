 ...
 *    WGDEVICE_A_LINKTRACK: NLA_U32, 0 to disable, 1 for any, 2 for all
 *    WGDEVICE_A_PEERS: NLA_NESTED
 *        0: NLA_NESTED
...
enum wgdevice_attribute_linktrack {
	WGLINKTRACK_A_UNSPEC,
	WGLINKTRACK_A_ANY,
	WGLINKTRACK_A_ALL,
	__WGLINKTRACK_A_LAST
};
#define WGLINKTRACK_A_MAX (__WGLINKTRACK_A_LAST - 1)
